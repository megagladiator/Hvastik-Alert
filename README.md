...
[![Version](https://img.shields.io/badge/version-1.2.33-blue.svg)](https://github.com/megagladiator/Hvastik-Alert)
...
## 🚀 Версия 1.2.33 - Исправления сброса пароля и деплоя

### 🆕 НОВОЕ: Полностью исправлена система сброса пароля
