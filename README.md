...
[![Version](https://img.shields.io/badge/version-1.2.93-blue.svg)](https://github.com/megagladiator/Hvastik-Alert)
...
## 🚀 Версия 1.2.93 - ФИНАЛЬНОЕ ИСПРАВЛЕНИЕ СИСТЕМЫ СБРОСА ПАРОЛЯ

### 🆕 КРИТИЧЕСКИЕ ИСПРАВЛЕНИЯ (v1.2.93)
- **✅ Установлен @supabase/ssr** - правильные Auth Helpers для Next.js App Router
- **✅ Создан Route Handler** - `/auth/callback/route.ts` для обработки PKCE flow
- **✅ Исправлены Supabase клиенты** - отдельные клиенты для сервера и клиента
- **✅ Устранена ошибка PKCE** - `PKCEGrantParams.auth_code` больше не возникает
- **✅ Исправлена автоматическая авторизация** - принудительный выход из сессии
- **✅ Правильная обработка magic links** - корректный flow сброса пароля

### 🆕 НОВОЕ: Централизованный модуль аутентификации (v1.2.74)
...
> - [MIGRATION_TO_SUPABASE_v1.1.2.md](./MIGRATION_TO_SUPABASE_v1.1.2.md)
> - [PASSWORD_RESET_FINAL_FIX_v1.2.93.md](./PASSWORD_RESET_FINAL_FIX_v1.2.93.md) - Финальное исправление системы сброса пароля
