...
import { MapPin, Search, Plus, Heart, MessageCircle, Phone, Star, CheckCircle, Users, Clock, Award } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50">
      ...
      <section className="bg-gradient-to-r from-orange-500 to-red-500 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-orange-100 mb-8 text-xl">Каждая минута важна, когда речь идет о поиске любимого питомца</p>
